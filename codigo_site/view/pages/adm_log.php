                  ...
                  <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                    <div class="card border-0 shadow rounded-3 my-5">
                      <div class="card-body p-4 p-sm-5">
                        <h5 class="card-title text-center mb-5 fw-light fs-5">Efetuar Loguin adm</h5>
                        <form action="http://www.localhost/codigo_site/adm" name="log" method="post">
                          <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="usuario" placeholder="nickname">
                            <label for="floatingInput">Usuario-adm</label>
                          </div>
                          <div class="form-floating mb-3">
                            <input type="password" class="form-control" name="senha" placeholder="Password">
                            <label for="floatingPassword">Senha-adm</label>
                          </div>
